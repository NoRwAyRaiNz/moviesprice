...
// TODO 接收传入的JSON
func Unmarshalapijson(){
	//params := url.Values{}
	//Url, err := url.Parse("https://itunes.apple.com/search")
	//if err != nil {
	//	fmt.Printf("send request failed, err%v\n", err.Error())
	//}
	//
	//params.Set("media", "movie")
	//params.Set("term", "1917")
	//// URLEncode 如果有中文参数
	...
	//if err != nil {
	//	fmt.Printf("response body failed, err%v\n", err.Error())
	//}
